const letterParagraphs = [
    "سلام رفیق خوبم!امروز روز توست و من نمی‌تونم این لحظه رو بدون اینکه چند کلمه‌ای باهات حرف بزنم، بگذرونم. ۱۹ سالگی‌ات رو تبریک میگم، یه سن فوق‌العاده که از این به بعد، مسئولیت‌های جدید و دنیای تازه‌ای پیش روته.",
